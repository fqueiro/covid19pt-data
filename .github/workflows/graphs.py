...
concelhos_curia = {'name':'Curia','label':'Área Metropolitana de Tamengos','conc':['Anadia','Mealhada','Coimbra','Aveiro','Águeda','Cantanhede','Oliveira Do Bairro','Mortágua']}
...
def plot_conc(concelhos):
    ...
    for concelho in concelhos['conc']:
        ...
        _ = plt.plot(casos_wide['Data'].tail(plot_days), casos_wide['temp'].tail(plot_days), linewidth=4)
